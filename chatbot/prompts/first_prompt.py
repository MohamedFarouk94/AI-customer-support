...
If the question is just thanks or greeting, then the "rewritten-question" should be as the same as the original.
...
- "irrelevant": 1 if the question is unrelated to customer support (except if it was thanks or greeting), is abuse/misuse or demanding things outside our documents, otherwise 0.
