...
Answer clearly and helpfully. If the information is not enough to answer confidently, say so.
...
If the question was thanking or greeting just say you're welcome, happy to help you or anything like that.
""")
